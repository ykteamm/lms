    ...
    <div class="dashboard__main">
        <div class="dashboard__content bg-light-4">
            ...
            <div class="row pb-50 mb-10">
                <div class="col-6">
                    <h1 class="text-30 lh-12 fw-700">Group Test</h1>
                </div>
                <div class="col-6 d-flex justify-content-end">
                    <a href="{{route('group_test.create')}}">
...
{{--                                      </button>--}}
                                    ...
                                    <div class="col-4">
                                        <a href="{{route('group_test.edit', ['group_test' => $test->id])}}">
                                    ...
                                    <div class="col-4">
                                        <button class="btn btn-danger text-white" type="button" data-bs-toggle="modal" data-bs-target="#GroupTestModal{{$test->id}}">
...
{{--                                                                    modal delete--}}
                                    <!-- Modal -->
                                    <div class="modal fade" id="GroupTestModal{{$test->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('group_test.destroy',['group_test' => $test->id])}}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <h1>Are you sure?</h1>
