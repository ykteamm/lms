...
@section('title','Create group test')
@section('action')
    <div class="dashboard__main">
        <div class="dashboard__content bg-light-4">
            <div class="row pb-50 mb-10">
                <div class="col-auto">
                    <h1 class="text-30 lh-12 fw-700">Create group test</h1>
                </div>
            </div>

            <div class="row">
                <form action="{{route('group_test.store')}}" method="POST" class="form-group">
                    @csrf
                    <div class="row">
                        <div class="mb-3">
                        ...
                        <div class="mb-3 mt-30">
                             <label for="test_json" class="form-label fw-700">Test json</label>
                                 <div class="form-group">
                                     <select multiple placeholder="Choose Test Json" data-allow-clear="1" id="test_json" name="test_json[]">
