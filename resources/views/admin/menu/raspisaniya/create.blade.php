...
@section('title','Create raspisaniya')
@section('action')
    <div class="dashboard__main">
        <div class="dashboard__content bg-light-4">
            <div class="row pb-50 mb-10">
                <div class="col-auto">
                    <h1 class="text-30 lh-12 fw-700">Create raspisaniya</h1>
                </div>
            </div>

            <div class="row">
                <form action="{{route('raspisaniya.store')}}" method="POST" class="form-group">
                    @csrf
                    <div class="row">
                        <div class="mb-3">
                        ...
                        <div class="mb-3 mt-30">
                             <label for="lesson_id" class="form-label fw-700">Lesson ID</label>
                                 <div class="form-group">
                                     <select multiple placeholder="Choose Lesson" data-allow-clear="1" id="lesson_id" name="lesson_id[]" required>
                                         <option value="">--Select--</option>
                                         @foreach($lesson as $test)
