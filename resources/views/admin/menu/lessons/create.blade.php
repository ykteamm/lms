    ...
    <div class="dashboard__main">
        <div class="dashboard__content bg-light-4">
            <div class="row pb-20 mb-10">
                <div class="col-3">
                    <a href="{{route('lessons-index',['module_id'=>$module_id->module_id])}}"
            ...
            <div class="row">
                <form action="{{route('lessons-video-dars')}}" method="POST" class="form-group"
                      enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" class="form-control" id="lesson_id" value="{{$lesson_id}}" name="lesson_id"
                           required>
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3">
