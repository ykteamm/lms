    ...
    <div class="dashboard__main">
        <div class="dashboard__content bg-light-4">
            ...
            <div class="row pb-20 mb-10">
                <div class="col-3">
                    <a href="{{route('module-index',['course_id'=>$module->course_id])}}"
            ...
            <div class="row pb-20 mb-10">
                ...
                <div class="col-6 d-flex justify-content-end">
                    ...
                    <button class="btn btn-success text-white" type="button" data-bs-toggle="modal"
                            data-bs-target="#CourseLessonCreate">
                        <i class="fas fa-plus"></i>
                        Yaratish
                    </button>

                    <div class="modal fade" id="CourseLessonCreate" tabindex="-1" aria-labelledby="exampleModalLabel"
                         aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{route('lessons.store')}}" method="POST" class="form-group"
                                          enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" class="form-control" id="module_id" value="{{$module->id}}"
                                               name="module_id">
                                        <div class="row">
                                            <div class="mb-3">
                        ...
                        <div class="row py-15">
                            <div class="col-5 text-center">
                                <button class="btn btn-primary text-white" type="button" data-bs-toggle="modal"
                                        data-bs-target="#CourseModalEdit{{$less->id}}">
                                    <i class="fas fa-edit"></i>
                                    Tahrirlash
                                </button>
                                {{--                                modal edit--}}
                                <!-- Modal -->
                                <div class="modal fade" id="CourseModalEdit{{$less->id}}" tabindex="-1"
                                     aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Siz {{$less->title}}
                                                    darsini tahrirlamoqchisiz!</h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <form action="{{route('lessons.update',$less->id)}}" method="POST"
                                                      class="form-group" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                                    <input type="hidden" value="{{$less->module_id}}"
                                                           class="form-control" id="module_id" name="module_id">
                                                    <div class="row">
                                                        <div class="mb-3">
                                                            <label for="title" class="form-label fw-700">Dars
                                                                nomi</label>
                                                            <input type="text" value="{{$less->title}}"
                            ...
                            <div class="col-5 text-center">
                                <button class="btn btn-danger text-white" type="button" data-bs-toggle="modal"
                                        data-bs-target="#CourseModal{{$less->id}}">
                                    <i class="fas fa-trash-alt"></i>
                                    O'chirish
                                </button>
                                {{--                                modal delete--}}
                                <div class="modal fade" id="CourseModal{{$less->id}}" tabindex="-1"
                                     aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog ">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Siz {{$less->title}}
                                                    darsini o'chirmoqchisiz!</h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <form action="{{route('lessons.destroy', ['lesson' => $less->id])}}"
                                                      method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <input type="hidden" value="{{$less->module_id}}"
