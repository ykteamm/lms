    ...
    <div class="dashboard__main">
        <div class="dashboard__content bg-light-4">
            ...
            <div class="row pb-50 mb-10">
                <div class="col-6">
                    <h1 class="text-30 lh-12 fw-700">Users check</h1>
                </div>
                <div class="col-6 d-flex justify-content-end">
                    <a href="{{route('users_check.create')}}">
            ...
            <div class="row y-gap-30">
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th scope="col">One day apteka</th>
                        <th scope="col">Action</th>
                    </tr>
                    </thead>
                    <tbody>
                    @foreach($user_check as $test)
                        <tr>
                            <th scope="row">{{$test->id}}</th>
                            <td>{{$test->user_id}}</td>
                            <td>{{$test->video}}</td>
                            <td>{{$test->one_day_apteka}}</td>
                            <td>
                                <div class="row">
                                    <div class="col-4">
                                    ...
                                    <div class="col-4">
                                        <a href="{{route('users_check.edit', ['users_check' => $test->id])}}">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('users_check.destroy',['users_check' => $test->id])}}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <h1>Are you sure?</h1>
