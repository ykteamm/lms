    ...
    <div class="dashboard__main">
        <div class="dashboard__content bg-light-4">
            <div class="row pb-50 mb-10">
                <div class="col-auto">
                    <h1 class="text-30 lh-12 fw-700">Videos</h1>
                </div>
            </div>

            <div class="row">
                <form action="{{route('video.store')}}" method="POST" class="form-group">
                    @csrf
                    <div class="row">
                        <div class="mb-3">
                        ...
                        <div class="col-12">
                             <div class="mb-3 mt-30 contact-form">
                                 ...
                                 <textarea placeholder="Content..." class="form-control" rows="7" name="content_type" style="outline: none;width: 100%;background-color: transparent; border-radius: 8px;border: 1px solid #DDDDDD; font-size: 15px;line-height: 1.5;padding: 15px 22px;transition: all 0.15s cubic-bezier(0.165, 0.84, 0.44, 1);"></textarea>
                             </div>
                            @error('content_type')
