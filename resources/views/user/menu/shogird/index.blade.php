                                                ...
                                                <div class="accordion-item border mt-20">
                                                    <h2 class="accordion-header" id="flush-heading{{$use['id']}}">
                                                        <button class="accordion-button collapsed"
                                                                style="background: green;color: white" type="button"
                                                                data-bs-toggle="collapse"
                                                                data-bs-target="#flush-collapse{{$use['id']}}"
                                                                aria-expanded="false"
                                                                aria-controls="flush-collapse{{$use['id']}}">
                                                            {{$use['firstname']}} {{$use['lastname']}}
                                                        </button>
                                                    </h2>
                                                    <div id="flush-collapse{{$use['id']}}"
                                                         class="accordion-collapse collapse"
                                                         aria-labelledby="flush-heading{{$use['id']}}"
                                                            ...
                                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt-20">
                                                                ...
                                                                @foreach($answer_check as $check)
                                                                    @foreach($check['data'] as $data)
                                                                        @if($data['user_id'] == $use['id'])
                                                                            @foreach($check['lesson_id'] as $ids)
                                                                                @php
                                                                                    $urinish = 1;
                                                                                    $number = 1;
                                                                                @endphp
                                                                                @if( $ids['lesson_id'] == $data['lesson_id'] )
                                                                                    @php
                                                                                        // Agar bu lesson_id allaqachon saqlangan bo'lsa, urinish sanasini o'zgartirish
                                                                                        if (isset($lesson_urinishlar[$ids['lesson_id']])) {
                                                                                            $lesson_urinishlar[$ids['lesson_id']]++;
                                                                                        } else {
                                                                                            // Agar bu lesson_id yangi bo'lsa, yangi element yaratish
                                                                                            $lesson_urinishlar[$ids['lesson_id']] = 1;
                                                                                        }
                                                                                    @endphp
                                                                                    <h4 class="fw-500 text-center">{{$ids['lesson_id']}}
                                                                                        Dars</h4>
                                                                                    <h6 class="fw-500 text-center">{{$lesson_urinishlar[$ids['lesson_id']]}}
                                                                                        - urinish</h6>
                                                                                    <div class="row">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-5"
                                                                                             style="border-left: 1px  solid black;border-right: 1px  solid black; border-bottom: 1px  solid black; padding: 0 !important;">
                                                                                            @foreach($data['user_answers'] as $questionNumber => $answer)
                                                                                                @php
