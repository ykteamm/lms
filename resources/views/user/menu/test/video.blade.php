        ...
        <div class="content-wrapper  js-content-wrapper">
             <section class="">
                 <div class="relative pt-40 col-12">
                     ...
                     <div class="absolute-full-center d-flex justify-center items-center">
                         <a href="{{$video_id->url}}" class="d-flex justify-center items-center size-60 rounded-full bg-white js-gallery" data-gallery="gallery1">
            ...
            @if($pass_data == null || $pass_data->pass_status != 1)
                <div class="text-center">
                    <a href="{{ url('user/lesson-test/'.$lesson_have->id.'/rasp_id/'.$raspisaniya->id) }}" class="btn btn-success mt-20">
                        Test yechish
                    </a>
                </div>
            @else
       ...
       <div class="content-wrapper  js-content-wrapper">
            <section class="">
                <div class="relative pt-40">
                    <img class="w-1/1" src="{{asset('assets/img/lesson-single/1.png')}}" alt="image">
                    <div class="absolute-full-center d-flex justify-center items-center">
                        <a href="{{$video_med_id->url}}" class="d-flex justify-center items-center size-60 rounded-full bg-white js-gallery" data-gallery="gallery1">
                            <div class="icon-play text-18"></div>
                        </a>
                    </div>
                </div>
           ...
           @if($pass_data == null || $pass_data->pass_status != 1)
               <div class="text-center">
                   <a href="{{ url('user/lesson-med-test/'.$lesson_have->id.'/rasp_id/'.$raspisaniya->id) }}" class="btn btn-success mt-20">
                       Test yechish
                   </a>
               </div>
           @else
